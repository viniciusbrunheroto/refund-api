...
--> Employee: pode se autenticar e cadastrar pedidos de reembolso em diferentes categorias (alimentação, transporte, hospedagem e outros), enviando os detalhes e o comprovante de pagamento.
--> Manager: pode se autenticar e visualizar todos os pedidos através de um dashboard, acessar os detalhes de cada solicitação (nome do solicitante, descrição, categoria e comprovante) e tomar as medidas necessárias.
